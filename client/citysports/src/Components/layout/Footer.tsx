          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-gray-900 border border-gray-700 rounded-2xl px-5 py-3 text-sm focus:outline-none focus:border-emerald-500 transition"
              />
              <button className="bg-emerald-600 hover:bg-emerald-700 px-8 rounded-2xl font-semibold transition">
                Join
              </button>
            </div>
