...
const blogPosts = [
  {
    ...
    excerpt: 'Discover the best football boots for speed, control, and power this season.',
  ...
  },
  {
    ...
    excerpt: 'A complete guide to finding the perfect fit for your football jersey.',
  ...
  },
  {
    ...
    excerpt: 'Vintage football jerseys are having a massive revival.',
  ...
  },
  {
    ...
    excerpt: 'Everything you need in your training bag for peak performance.',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {/* Featured Post */}
        {featured && (
          <Link to={`/blog/${featured.id}`} className="group block mb-14">
            ...
            <Link key={post.id} to={`/blog/${post.id}`} className="group">
              <article className="overflow-hidden rounded-[2rem] border border-gray-100 bg-white hover:shadow-xl transition-all duration-500 h-full flex flex-col">
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <p className="mt-3 text-gray-500 leading-relaxed flex-1">{post.excerpt}</p>
        ...
        {filtered.length === 0 && (
          <div className="py-24 text-center">
            ...
            <p className="mt-3 text-gray-400">Try another category or search term.</p>
          </div>
        )}
      </div>
    </div>
